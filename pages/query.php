...
<body>
    ...
    <div class="table_parent_div">
        ...
        if (isset($_POST["table"]))
        {
            ...
            switch ($_POST["table"])
            {
                case "csapat": display_csapat($conn); break;
                case "nagydij": display_nagydij($result); break;
                case "palya": display_palya($result); break;
                case "resztvesz": display_reszt_vesz($conn); break;
                case "sofor": display_sofor($result); break;
                case "soforbajnoksag": display_soforbajnoksag($result); break;
                case "versenyez": display_versenyez($conn); break;
                default: die("Incorrect radio button!");
            }
